    ...
    AwesomeNotifications()
        ...
        .then(
          (List<NotificationPermission> permissionsAllowed) => setState(() {
            ...
            for (NotificationPermission permission in channelPermissions) {
              scheduleChannelPermissions[permission] = permissionsAllowed
                  .contains(permission);
  ...
  void refreshDangerousChannelPermissions() {
    AwesomeNotifications()
        ...
        .then(
          (List<NotificationPermission> permissionsAllowed) => setState(() {
            for (NotificationPermission permission in dangerousPermissions) {
              dangerousPermissionsStatus[permission] = permissionsAllowed
                  .contains(permission);
            }
            isCriticalAlertsEnabled =
                dangerousPermissionsStatus[NotificationPermission
                    .CriticalAlert]!;
      ...
      body: ListView(
        ...
        children: <Widget>[
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showNotificationWithSilentActionButtons(30),
          ),
          SimpleButton(
          ...
          Wrap(
            ...
            children: <Widget>[
              ...
              PermissionIndicator(
                name: 'Vibrations',
                allowed:
                    scheduleChannelPermissions[NotificationPermission
                        .Vibration]!,
              ),
              PermissionIndicator(
                name: 'Lights',
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showBigPictureAndLargeIconNotification(2),
          ),
          SimpleButton(
            'Show big picture notification,\n but hide large icon on expand',
            onPressed: () =>
                NotificationUtils.showBigPictureNotificationHideExpandedLargeIcon(
                  2,
                ),
          ),
          SimpleButton(
          ...
          /* ******************************************************************** */
          TextDivisor(
            title: 'Emojis ${Emojis.smile_alien}${Emojis.transport_air_rocket}',
          ),
          const TextNote(
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showNotificationWithLocalizationsKeyBlock(1),
          ),
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showNotificationWithIconsAndActionButtons(3),
          ),
          SimpleButton(
            'Show notification with\nReply and Action button',
            onPressed: () =>
                NotificationUtils.showNotificationWithActionButtonsAndReply(3),
          ),
          SimpleButton(
            'Show Big picture notification\nwith Action Buttons',
            onPressed: () =>
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showBigPictureNotificationActionButtonsAndReply(
                  3,
                ),
          ),
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showBigTextNotificationWithActionAndReply(3),
          ),
          SimpleButton(
            'Cancel notification',
            backgroundColor: Colors.red,
          ...
          SimpleButton(
            ...
            onPressed: () =>
                NotificationUtils.showBadgeNotification(Random().nextInt(100)),
          ),
          SimpleButton(
          ...
          SimpleButton(
            ...
            onPressed: () async {
              int currentAmount = await NotificationUtils.getBadgeIndicator();
              if (!context.mounted) return;

              int? amount = await pickBadgeCounter(context, currentAmount);
              if (amount != null) {
          ...
          SimpleButton(
            ...
            onPressed: () async {
              final String timeZone =
                  await NotificationUtils.getCurrentTimeZone();
              if (!context.mounted) return;
          ...
          SimpleButton(
            ...
            onPressed: () async {
              final String timeZone = await NotificationUtils.getUtcTimeZone();
              if (!context.mounted) return;
          ...
          SimpleButton(
            ...
            labelColor: Colors.white,
            onPressed: () =>
                NotificationUtils.dismissNotificationsByChannelKey('scheduled'),
          ),
          SimpleButton(
          ...
          SimpleButton(
            ...
            labelColor: Colors.white,
            onPressed: () =>
                NotificationUtils.cancelNotificationsByChannelKey('scheduled'),
          ),
          ...
          SimpleButton(
            ...
            labelColor: Colors.white,
            onPressed: () =>
                NotificationUtils.cancelNotificationsByGroupKey('jhonny_group'),
          ),
          ...
          SimpleButton(
            ...
            labelColor: Colors.white,
            onPressed: () =>
                NotificationUtils.dismissNotificationsByChannelKey('grouped'),
          ),
          ...
          SimpleButton(
            ...
            labelColor: Colors.white,
            onPressed: () =>
                NotificationUtils.dismissNotificationsByGroupKey('grouped'),
          ),
          SimpleButton(
