...
class PhoneCallPage extends StatefulWidget {
  ...
  const PhoneCallPage({super.key, required this.receivedAction});
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Stack(
        ...
        children: [
          ...
          // Black Layer
          const DecoratedBox(decoration: BoxDecoration(color: Colors.black45)),
          Padding(
            ...
            child: SafeArea(
              child: Column(
                ...
                children: [
                  Text(
                    widget.receivedAction.payload?['username']?.replaceAll(
                          r'\s+',
                          r'\n',
                        ) ??
                        'Unknown',
