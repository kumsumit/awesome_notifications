...
class NotificationUtils {
  ...
  static Future<bool> requestBasicPermissionToSendNotifications(
    ...
    if (!isAllowed) {
      if (!context.mounted) return isAllowed;
  ...
  static Future<List<NotificationPermission>> requestUserPermissions(
    ...
    if (lockedPermissions.isEmpty) {
      ...
      if (!context.mounted) return permissionsAllowed;
  ...
  static Future<void> showNotificationWithLocalizationsBlock(int id) async {
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        body:
            'Now it is really easy to translate a notification content, '
      ...
      localizations: {
        'pt-br': NotificationLocalization(
          ...
          body:
              'Agora é muito fácil traduzir o conteúdo das notificações, '
  ...
  static Future<void> showNotificationWithSilentActionButtons(int id) async {
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        body:
            'Click on the buttons above to test each action type:'
  ...
  ************************************************ */
  ...
  static Future<void> showCallNotification(int id, int timeToWait) async {
    ...
    await AwesomeNotifications().createNotification(
      ...
      schedule: NotificationInterval(interval: Duration(seconds: 5)),
    );
  }
  ...
  ************************************************ */
  ...
  static Future<void> removeTestChannel(String channelName) async {
    await AwesomeNotifications().removeChannel(
  ...
  ************************************************ */
  ...
  static Future<void> redNotification(int id, bool delayLEDTests) async {
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        id: id,
        channelKey: "colorful_notification",
        title: "<font color='${Colors.red.toARGB32()}'>Red Notification</font>",
        body:
            "<font color='${Colors.red.toARGB32()}'>A colorful notification</font>",
  ...
  static Future<void> blueNotification(int id, bool delayLEDTests) async {
    await AwesomeNotifications().setChannel(
      NotificationChannel(
        channelKey: "colorful_notification_blue",
        channelName: "Blue Colorful notifications",
        channelDescription: "A red colorful notification",
        vibrationPattern: lowVibrationPattern,
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        channelKey: "colorful_notification_blue",
        title:
            '<font color="${Colors.blueAccent.toARGB32()}">Blue Notification</font>',
        body:
            "<font color='${Colors.blueAccent.toARGB32()}'>A colorful notification</font>",
  ...
  static Future<void> purpleNotification(int id, bool delayLEDTests) async {
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        channelKey: "colorful_notification",
        title:
            '<font color="${Colors.deepPurple.toARGB32()}">Purple Notification</font>',
        body:
            "<font color='${Colors.deepPurple.toARGB32()}'>A colorful notification</font>",
  ...
  static Future<void> greenNotification(int id, bool delayLEDTests) async {
    ...
    await AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        channelKey: "colorful_notification",
        title:
            '<font color="${Colors.lightGreen.toARGB32()}">Green Notification</font>',
        body:
            "<font color='${Colors.lightGreen.toARGB32()}'>A colorful notification</font>",
        color: Colors.purple,
    ...
    AwesomeNotifications().createNotification(
      content: NotificationContent(
        ...
        progress:
            ...
            mediaNow.trackSize.inMilliseconds *
            100,
        playbackSpeed: 1,
        playState: playState,
  ...
  ************************************************ */
  ...
  static Future<void> listScheduledNotifications(BuildContext context) async {
    List<NotificationModel> activeSchedules = await AwesomeNotifications()
  ...
  static Future<void> getNextValidMonday(BuildContext context) async {
    ...
    DateTime? nextValidDate = await AwesomeNotifications().getNextDate(
      schedule,
      fixedDate: referenceDate,
    );
