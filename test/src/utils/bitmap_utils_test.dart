...
void main() {
  ...
  group('getFromMediaPath()', () {
    test('Unknown media path', () {
      expect(
        bitmapUtils.getFromMediaPath('unknown:///path/to/image.png'),
        null,
      );
    });

    test('Network media path', () {
      ImageProvider? imageProvider1 = bitmapUtils.getFromMediaPath(
        'http://example.com/image.png',
      );
      expect(imageProvider1, isA<NetworkImage>());

      ImageProvider? imageProvider2 = bitmapUtils.getFromMediaPath(
    ...
    test('File media path', () {
      ImageProvider? imageProvider = bitmapUtils.getFromMediaPath(
