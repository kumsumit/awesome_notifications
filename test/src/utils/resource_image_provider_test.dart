...
void main() {
  group('ResourceImage tests', () {
    test(
      'ResourceImage constructor creates an instance with provided data',
      () {
        ResourceImage resourceImage = const ResourceImage(
          'drawable_path',
          scale: 2.0,
        );
    ...
    test('ResourceImage equality and hashCode', () {
      ResourceImage resourceImage1 = const ResourceImage(
        'drawable_path',
        scale: 2.0,
      );
      ResourceImage resourceImage2 = const ResourceImage(
        'drawable_path',
        scale: 2.0,
      );
      ResourceImage resourceImage3 = const ResourceImage(
        'different_drawable_path',
        scale: 2.0,
      );
      ResourceImage resourceImage4 = const ResourceImage(
        'drawable_path',
        scale: 1.0,
      );
    ...
    testWidgets('ResourceImage loads and displays the image', (
      ...
      when(() => awesomeNotifications.getDrawableData(any())).thenAnswer((
        _,
      ) async {
          ...
          home: Material(
            child: Builder(
              builder: (BuildContext context) {
                return Image(image: resourceImage);
              },
            ),
          ),
        ),
    ...
    testWidgets('ResourceImage fails to load and display the invalid image', (
      ...
      expect(() {
        ...
        return resourceImage.loadAsync(
          resourceImage,
          (buffer, {TargetImageSizeCallback? getTargetSize}) =>
