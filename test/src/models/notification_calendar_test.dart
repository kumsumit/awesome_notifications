...
void main() {
  group('NotificationCalendar', () {
    ...
    test('should throw an exception a NotificationCalendar '
    ...
    test(
      'should create a NotificationCalendar object fromDate using local',
      () {
        DateTime date = DateTime(2023, 5, 1, 12, 30, 45);
        NotificationCalendar calendar = NotificationCalendar.fromDate(
          date: date,
        );
