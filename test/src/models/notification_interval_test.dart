...
void main() {
  group('NotificationInterval', () {
    test('should create a NotificationInterval object fromMap', () {
      Map<String, dynamic> dataMap = {NOTIFICATION_SCHEDULE_INTERVAL: 120};
  ...
  group('NotificationInterval - toMap and fromMap', () {
    test(
      'should create a NotificationInterval object and convert it to a map',
      () {
        ...
        expect(
          intervalMap[NOTIFICATION_SCHEDULE_INTERVAL],
          120,
        ); // interval in seconds
      },
    );
