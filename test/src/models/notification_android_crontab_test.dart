...
void main() {
  group('NotificationAndroidCrontab', () {
    ...
    test('fromMap', () {
      ...
      Map<String, dynamic> crontabMap = {
        NOTIFICATION_INITIAL_DATE_TIME: AwesomeDateUtils.parseDateToString(
          initialDate,
        ),
        NOTIFICATION_EXPIRATION_DATE_TIME: AwesomeDateUtils.parseDateToString(
          expirationDate,
        ),
      ...
      NotificationAndroidCrontab crontab =
          NotificationAndroidCrontab().fromMap(crontabMap)
              as NotificationAndroidCrontab;
  ...
  group('NotificationAndroidCrontab factories using local date', () {
    ...
    test(
      ...
      () {
        DateTime date = DateTime(2023, 5, 2, 15, 30);
        NotificationAndroidCrontab crontab = NotificationAndroidCrontab.yearly(
    ...
    test(
      ...
      () {
        DateTime date = DateTime(2023, 5, 2, 15, 30);
        NotificationAndroidCrontab crontab = NotificationAndroidCrontab.monthly(
          referenceDateTime: date,
        );
    ...
    test(
      ...
      () {
        DateTime date = DateTime(2023, 5, 2, 15, 30);
        NotificationAndroidCrontab crontab = NotificationAndroidCrontab.weekly(
          referenceDateTime: date,
        );
    ...
    test(
      ...
      () {
        DateTime date = DateTime(2023, 5, 2, 15, 30);
        NotificationAndroidCrontab crontab = NotificationAndroidCrontab.daily(
          referenceDateTime: date,
        );
    ...
    test(
      ...
      () {
        DateTime date = DateTime(2023, 5, 2, 15, 30);
        NotificationAndroidCrontab crontab = NotificationAndroidCrontab.hourly(
          referenceDateTime: date,
        );
    ...
    test(
      ...
      () {
        Map<String, dynamic> mapData = {
          ...
          NOTIFICATION_INITIAL_DATE_TIME: DateTime(
            2023,
            5,
            2,
            15,
          ...
          NOTIFICATION_EXPIRATION_DATE_TIME: DateTime(
            2023,
            5,
            10,
            15,
