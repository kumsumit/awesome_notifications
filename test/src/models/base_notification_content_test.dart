  ...
  group('BaseNotificationContent tests', () {
    group('toMap method', () {
      test('id field', () {
        ...
        expect(
          BaseNotificationContent(id: 1).toMap()[NOTIFICATION_ID],
          1,
          reason: failureReason,
        );
        expect(
          BaseNotificationContent(id: 0).toMap()[NOTIFICATION_ID],
          0,
          reason: failureReason,
        );
        expect(
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_ID],
          defaultValue,
          reason: failureReason,
        );
      });
      ...
      test('channelKey field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_CHANNEL_KEY],
          defaultValue,
      ...
      test('groupKey field', () {
        ...
        expect(
          BaseNotificationContent(groupKey: '').toMap()[NOTIFICATION_GROUP_KEY],
          '',
          reason: '$failureReason: empty string value',
        );
        expect(
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_GROUP_KEY],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('actionType field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_ACTION_TYPE],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('title field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_TITLE],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('body field', () {
        ...
        expect(
          BaseNotificationContent(body: '').toMap()[NOTIFICATION_BODY],
          '',
          reason: '$failureReason: empty string value',
        );
        expect(
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_BODY],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('summary field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_SUMMARY],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('showWhen field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_SHOW_WHEN],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('icon field', () {
        ...
        expect(
          BaseNotificationContent(icon: 'icon_name').toMap()[NOTIFICATION_ICON],
          'icon_name',
          reason: '$failureReason: normal string value',
        );
        expect(
          BaseNotificationContent(icon: '').toMap()[NOTIFICATION_ICON],
          '',
          reason: '$failureReason: empty string value',
        );
        expect(
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_ICON],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('largeIcon field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_LARGE_ICON],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('bigPicture field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_BIG_PICTURE],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('wakeUpScreen field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_WAKE_UP_SCREEN],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('criticalAlert field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_CRITICAL_ALERT],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('category field', () {
        ...
        NotificationCategory? defaultValue =
            Definitions.initialValues[NOTIFICATION_CATEGORY]
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_CATEGORY],
          defaultValue?.name,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('color field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_COLOR],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('backgroundColor field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_BACKGROUND_COLOR],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('timeoutAfter field', () {
        ...
        expect(
          BaseNotificationContent(
            timeoutAfter: const Duration(seconds: 1000),
        ...
        expect(
          BaseNotificationContent(
            timeoutAfter: const Duration(seconds: 0),
          ).toMap()[NOTIFICATION_TIMEOUT_AFTER],
          0,
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_TIMEOUT_AFTER],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('customSound field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_CUSTOM_SOUND],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('roundedBigPicture field', () {
        ...
        bool? defaultValue =
            Definitions.initialValues[NOTIFICATION_ROUNDED_BIG_PICTURE]
                as bool?;
      ...
      test('autoDismissible field', () {
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_AUTO_DISMISSIBLE],
          defaultValue,
          reason: '$failureReason: default value',
        );
      });
      ...
      test('payload field', () {
        ...
        Map<String, String?>? defaultValue =
            Definitions.initialValues[NOTIFICATION_PAYLOAD]
        ...
        expect(
          BaseNotificationContent().toMap()[NOTIFICATION_PAYLOAD],
          defaultValue,
          reason: '$failureReason: default value',
        );
        ...
        final customBaseWithPayload = BaseNotificationContent(
          payload: customPayload,
        ).toMap();
        expect(
          customBaseWithPayload[NOTIFICATION_PAYLOAD],
          customPayload,
          reason: '$failureReason: custom payload',
        );
        expect(
          customBaseWithPayload[NOTIFICATION_PAYLOAD]['key1'],
          'value1',
          reason: '$failureReason: custom payload',
        );
        expect(
          customBaseWithPayload[NOTIFICATION_PAYLOAD]['key2'],
          'value2',
          reason: '$failureReason: custom payload',
        );
        expect(
          customBaseWithPayload[NOTIFICATION_PAYLOAD].length,
          2,
          reason: '$failureReason: custom payload',
        );
      });
    ...
    group('fromMap method', () {
      test('id field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_ID: 1})?.id,
          1,
          reason: '$failureReason: positive value',
        );
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_ID: 0})?.id,
          0,
          reason: '$failureReason: positive value',
        );
        expect(
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_ID: null})?.id,
          defaultValue,
          reason: '$failureReason: positive value',
        );
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_ID: ""})?.id,
          defaultValue,
          reason: '$failureReason: positive value',
        );
      });
      ...
      test('channelKey field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CHANNEL_KEY: 'channel_1',
          })?.channelKey,
          'channel_1',
          reason: '$failureReason: normal string value',
        );
      ...
      test('actionType field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ACTION_TYPE: 'SilentAction',
          })?.actionType,
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ACTION_TYPE: 'DisabledAction',
          })?.actionType,
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ACTION_TYPE: 'DismissAction',
          })?.actionType,
      ...
      test('groupKey field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_GROUP_KEY: 'group_1',
          })?.groupKey,
          'group_1',
          reason: '$failureReason: normal string value',
        );
      ...
      test('title field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_TITLE: null})?.title,
          defaultValue,
          reason: '$failureReason: null value',
        );
        expect(
      ...
      test('body field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_BODY: 1})?.body,
          defaultValue,
          reason: '$failureReason: non-string value',
        );
      });
      ...
      test('summary field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_SUMMARY: 1})?.summary,
          defaultValue,
          reason: '$failureReason: non-string value',
        );
      });
      ...
      test('icon field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_ICON: 1})?.icon,
          defaultValue,
      ...
      test('largeIcon field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_LARGE_ICON: 'large_icon_1',
          })?.largeIcon,
          'large_icon_1',
          reason: '$failureReason: normal string value',
        );
      ...
      test('bigPicture field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_BIG_PICTURE: 'big_picture_1',
          })?.bigPicture,
          'big_picture_1',
          reason: '$failureReason: normal string value',
        );
      ...
      test('wakeUpScreen field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_WAKE_UP_SCREEN: true,
          })?.wakeUpScreen,
          true,
          reason: '$failureReason: true value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_WAKE_UP_SCREEN: null,
          })?.wakeUpScreen,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('fullScreenIntent field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_FULL_SCREEN_INTENT: true,
          })?.fullScreenIntent,
          true,
          reason: '$failureReason: true value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_FULL_SCREEN_INTENT: 1,
          })?.fullScreenIntent,
          true,
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_FULL_SCREEN_INTENT: 0,
          })?.fullScreenIntent,
          false,
          reason: '$failureReason: non-boolean value (int)',
        );
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_FULL_SCREEN_INTENT: null,
          })?.fullScreenIntent,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('criticalAlert field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CRITICAL_ALERT: true,
          })?.criticalAlert,
          true,
          reason: '$failureReason: true value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CRITICAL_ALERT: null,
          })?.criticalAlert,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('category field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CATEGORY: 'invalid_value',
          })?.category,
          defaultValue,
      ...
      test('color field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_COLOR: 'invalid_color',
          })?.color,
          defaultValue,
        ...
        expect(
          BaseNotificationContent().fromMap({NOTIFICATION_COLOR: null})?.color,
          defaultValue,
          reason: '$failureReason: null value',
        );
      });
      ...
      test('backgroundColor field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_BACKGROUND_COLOR: '#00FF00',
          })?.backgroundColor,
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_BACKGROUND_COLOR: '#FF00FF00',
          })?.backgroundColor,
          const Color(0xFF00FF00),
          reason: '$failureReason: valid hex color value with hash symbol',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_BACKGROUND_COLOR: null,
          })?.backgroundColor,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('timeoutAfter field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_TIMEOUT_AFTER: 1000,
          })?.timeoutAfter,
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_TIMEOUT_AFTER: null,
          })?.timeoutAfter,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('payload field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_PAYLOAD: customPayload,
          })?.payload,
      ...
      test('customSound field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CUSTOM_SOUND: 'sound.wav',
          })?.customSound,
          'sound.wav',
          reason: '$failureReason: valid value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_CUSTOM_SOUND: null,
          })?.customSound,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('roundedLargeIcon field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ROUNDED_LARGE_ICON: true,
          })?.roundedLargeIcon,
          true,
          reason: '$failureReason: true value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ROUNDED_LARGE_ICON: null,
          })?.roundedLargeIcon,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('roundedBigPicture field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ROUNDED_BIG_PICTURE: true,
          })?.roundedBigPicture,
          true,
          reason: '$failureReason: true value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_ROUNDED_BIG_PICTURE: null,
          })?.roundedBigPicture,
          defaultValue,
          reason: '$failureReason: null value',
        );
      ...
      test('autoDismissible field fromMap', () {
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_AUTO_DISMISSIBLE: false,
          })?.autoDismissible,
          false,
          reason: '$failureReason: false value',
        );
        ...
        expect(
          BaseNotificationContent().fromMap({
            NOTIFICATION_AUTO_DISMISSIBLE: null,
          })?.autoDismissible,
          defaultValue,
          reason: '$failureReason: null value',
        );
    ...
    group('processRetroCompatibility method', () {
      test('autoCancel field fromMap', () {
        expect(
          ...
          true,
          reason: 'The deprecated autoCancel field should have been removed.',
        );
      ...
      test('AppKilled enum deprecated', () {
        expect(
          ...
          reason:
              'The deprecated AppKilled value should have been '
    ...
    test('bigPictureImage method', () {
      BaseNotificationContent contentWithBigPicture = BaseNotificationContent(
        bigPicture: 'asset://path/to/bigPicture',
      );

      expect(
        contentWithBigPicture.bigPictureImage,
        isNotNull,
      ...
      expect(
        contentWithoutBigPicture.bigPictureImage,
        isNull,
    ...
    test('largeIconImage method', () {
      BaseNotificationContent contentWithLargeIcon = BaseNotificationContent(
        largeIcon: 'asset://path/to/largeIcon',
      );

      expect(
        contentWithLargeIcon.largeIconImage,
        isNotNull,
      ...
      expect(
        contentWithoutLargeIcon.largeIconImage,
        isNull,
    ...
    test('bigPicturePath method', () {
      ...
      expect(
        contentWithBigPicture.bigPicturePath,
        'path/to/bigPicture',
        reason:
      ...
      expect(
        contentWithoutBigPicture.bigPicturePath,
        isNull,
    ...
    test('largeIconPath method', () {
      ...
      expect(
        contentWithLargeIcon.largeIconPath,
        'path/to/largeIcon',
        reason:
      ...
      expect(
        contentWithoutLargeIcon.largeIconPath,
        isNull,
    ...
    test('titleWithoutHtml method', () {
      BaseNotificationContent contentWithTitle = BaseNotificationContent(
        title: '<b>Title</b>',
      );

      expect(
        contentWithTitle.titleWithoutHtml,
        'Title',
        reason: 'titleWithoutHtml should return the title without HTML tags.',
      );

      BaseNotificationContent contentWithoutTitle = BaseNotificationContent();

      expect(
        contentWithoutTitle.titleWithoutHtml,
        isNull,
    ...
    test('bodyWithoutHtml method', () {
      BaseNotificationContent contentWithBody = BaseNotificationContent(
        body: '<i>Body</i>',
      );

      expect(
        contentWithBody.bodyWithoutHtml,
        'Body',
      ...
      expect(
        contentWithoutBody.bodyWithoutHtml,
        isNull,
