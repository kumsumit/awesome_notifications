...
class AwesomeDateUtils {
  static DateTime? parseStringToDateUtc(
    String? date, {
  ...
  static DateTime? parseStringToDate(
    String? date, {
    String format = 'yyyy-MM-dd HH:mm:ss',
  }) {
    if (date == null || date.isEmpty) return null;
  ...
  static String? parseDateToString(
    DateTime? date, {
    String format = 'yyyy-MM-dd HH:mm:ss',
  }) {
  ...
  static DateTime utcToLocal(
    ...
    DateTime parsedUTCDate = DateFormat(
      format,
    ).parseUTC(parseDateToString(date)!);
  ...
  static DateTime localToUtc(
    ...
    DateTime parsedLocalDate = DateFormat(
      format,
    ).parse(parseDateToString(date)!);
