...
class NotificationChannel extends Model {
  ...
  NotificationChannel({
    ...
    channelShowBadge = AwesomeAssertUtils.getValueOrDefault<bool>(
      NOTIFICATION_CHANNEL_SHOW_BADGE,
      channelShowBadge,
    );
    ...
    criticalAlerts = AwesomeAssertUtils.getValueOrDefault<bool>(
      NOTIFICATION_CHANNEL_CRITICAL_ALERTS,
      criticalAlerts,
    );
    ...
    locked = AwesomeAssertUtils.getValueOrDefault<bool>(
      NOTIFICATION_LOCKED,
      locked,
    );
    ...
    assert(
      AwesomeStringUtils.isNullOrEmpty(icon) ||
  ...
  Map<String, dynamic> toMap() {
    return <String, dynamic>{
      ...
      NOTIFICATION_DEFAULT_COLOR: defaultColor?.toARGB32(),
      NOTIFICATION_LED_COLOR: ledColor?.toARGB32(),
  ...
  NotificationChannel fromMap(Map<String, dynamic> mapData) {
    ...
    playSound = AwesomeAssertUtils.extractValue<bool>(
      NOTIFICATION_PLAY_SOUND,
      mapData,
    );
    ...
    locked = AwesomeAssertUtils.extractValue<bool>(
      NOTIFICATION_LOCKED,
      mapData,
    );
    ...
    ledColor = AwesomeAssertUtils.extractValue<Color>(
      NOTIFICATION_LED_COLOR,
      mapData,
    );

    ledOnMs = AwesomeAssertUtils.extractValue<int>(
      NOTIFICATION_LED_ON_MS,
      mapData,
    );
    ledOffMs = AwesomeAssertUtils.extractValue<int>(
      NOTIFICATION_LED_OFF_MS,
      mapData,
    );
