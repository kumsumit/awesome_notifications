...
const NOTIFICATION_REQUEST_PROMOTED_ONGOING = 'requestPromotedOngoing';
const NOTIFICATION_SHORT_CRITICAL_TEXT = 'shortCriticalText';
...
class Definitions {
  static Map<String, Object?> initialValues = {
    ...
    NOTIFICATION_REQUEST_PROMOTED_ONGOING: false,
